...
namespace implemented
{
	...
	public:
		...
		T2Camera(const glm::vec3& position, const glm::vec3& center, const glm::vec3& up)
		{
		...
		{
			// TODO(student): Translate the camera using the `up` vector.
			// Movement will always keep the camera at the same distance to
			// the ground. For example, if you rotate your head up
